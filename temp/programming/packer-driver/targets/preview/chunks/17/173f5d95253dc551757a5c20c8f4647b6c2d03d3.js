System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  function ChangeMirror() {
    ...
    for (var _i = 0; _i < (_crd && LS_array === void 0 ? (_reportPossibleCrUseOfLS_array({
      error: Error()
    }), LS_array) : LS_array).length; _i++) L_array[_i] = (_crd && LS_array === void 0 ? (_reportPossibleCrUseOfLS_array({
      error: Error()
    }), LS_array) : LS_array)[_i];
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Mirror", Mirror = (_dec = ccclass('Mirror'), _dec(_class2 = (_class3 = class Mirror extends Component {
        ...
        GetMirrorIndex() {
          for (var i = 0; i < mirror_array.length; i++) {
        ...
        touchEnd(event) {
          ...
          if (this.isClick) {
            ...
            if (this.area == 1) {
              ...
              ChangeMirror();
              var maintheme = this.node.parent.getComponent(_crd && MainTheme === void 0 ? (_reportPossibleCrUseOfMainTheme({
                error: Error()
              }), MainTheme) : MainTheme);
              maintheme.Success();
            } else {
            ...
            var x = event.getUILocation().x - 562.5;
            var y = event.getUILocation().y - 1218;
            var new_x;
            var new_y;
            ...
            if (x >= (_crd && MapInfo === void 0 ? (_reportPossibleCrUseOfMapInfo({
              ...
              if ((_crd && matrix1 === void 0 ? (_reportPossibleCrUseOfmatrix({
                ...
                var [r0, g0, b0] = [false, false, false];
                ...
                var _maintheme = this.node.parent.getComponent(_crd && MainTheme === void 0 ? (_reportPossibleCrUseOfMainTheme({
                  error: Error()
                }), MainTheme) : MainTheme);
              ...
              if ((_crd && matrix2 === void 0 ? (_reportPossibleCrUseOfmatrix2({
                ...
                if (this.area == 1) {
                  ...
                  var _maintheme2 = this.node.parent.getComponent(_crd && MainTheme === void 0 ? (_reportPossibleCrUseOfMainTheme({
                    error: Error()
                  }), MainTheme) : MainTheme);
